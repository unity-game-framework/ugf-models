...
{
    public class CollectionListModelController<TModel> : ModelController<CollectionListModel<TModel>> where TModel : IModel
    {
        ...
        public event CollectionListModelClearHandler<TModel> Cleared;
